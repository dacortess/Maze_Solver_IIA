...
Node DFSWithTree(vector<vector<char>>& maze, vector<pair<int, int>>& traverse, Node start, Node end, bool& failure, vector<pair<int, int>>& tree){
...
int main(int argc, char **argv) {
    Solver DFS_Solver(argv[1], "DFS", &DFS, &DFSWithTree);
    return 0;
}
